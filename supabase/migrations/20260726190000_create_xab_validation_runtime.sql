create table if not exists public.xab_validation_runs (
...
create table if not exists public.xab_validation_browser_jobs (
  id uuid primary key default gen_random_uuid(),
  run_id uuid not null references public.xab_validation_runs(id) on delete cascade,
...
create table if not exists public.xab_validation_receipts (
  id uuid primary key default gen_random_uuid(),
  run_id uuid not null references public.xab_validation_runs(id) on delete cascade,
  kind text not null,
...
create index if not exists xab_validation_runs_mission_created_idx on public.xab_validation_runs (mission_id, created_at desc);
create index if not exists xab_validation_browser_jobs_run_idx on public.xab_validation_browser_jobs (run_id, created_at);
create index if not exists xab_validation_receipts_run_idx on public.xab_validation_receipts (run_id, created_at);
...
-- rollback:
-- drop table if exists public.xab_validation_receipts;
-- drop table if exists public.xab_validation_browser_jobs;
-- drop table if exists public.xab_validation_runs;
